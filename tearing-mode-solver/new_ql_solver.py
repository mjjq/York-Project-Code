...
def flux_time_derivative(var: float,
                         time: float,
    ...
    return dpsi_dt, d2psi_dt2, w_new
...
def solve_time_dependent_system(poloidal_mode: int,
    ...
    result = odeint(
        ...
        (psi_t0, dpsi_dt_t0, island_width_t0),
        t_range,
        args = (
            tm,
            poloidal_mode,
    ...
    print(result.shape)
    psi, dpsi_dt, w_t = np.split(result, 3, axis=1)
