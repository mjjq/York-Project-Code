...
{
	python3 -m jorek_tools.delta_psi_extraction.plot_delta_psi_vs_time -f postproc/exprs_four2d_s*abs*n001.dat -q $(find postproc/qprofile_*.dat | head -n 1) -t postproc/times.txt "$@"
}
